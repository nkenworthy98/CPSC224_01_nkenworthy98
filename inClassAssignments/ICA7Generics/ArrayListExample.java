...
class ArrayListExample {
    ...
    // total_area -- takes a list of 2-d shapes and calculates the total // area of those shapes
    ...
    public static double total_area(ArrayList<? extends TwoDShape> shapes) {
    ...
    public static double total_perimeter(ArrayList<? extends TwoDShape> shapes) {
	double theDouble = 0.0;
	for (TwoDShape s: shapes)
	    theDouble += s.perimeter();
	return theDouble;
    }
